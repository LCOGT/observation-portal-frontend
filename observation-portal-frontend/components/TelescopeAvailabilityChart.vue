...
<script>
  ...
  import { siteCodeToName, observatoryCodeToNumber, telescopeCodeToName } from '~/assets/js/utils.js';
  ...
  export default {
    ...
    mounted: function(){
      ...
      $.getJSON(this.$config.portalUrl + '/api/telescope_availability/?start=' + startDate.toISOString() + '&end=' + endDate.toISOString(),
        function(data){
