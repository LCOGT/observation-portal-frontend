  ...
  <b-row>
      ...
      <b-form @submit="updateProfileData" @reset="clearProfileForm">
        ...
        >
          <template slot="description">
            <p>
              Recieve email notifications for every completed observation on all proposals. To recieve
              email notifications for a single proposal, update your preferences on that proposal's detail page.
            </p>
          </template>
          <b-form-checkbox
        ...
        <b-form-group
          ...
          label-for="checkbox-notifications-on-authored-only"
        >
          <template slot="description">
            <p>
              Only recieve email notifications for requests you have submitted yourself. Note
              this setting alone does not enable any notifications. You must either enable the
              "Notifications enabled" setting above or enable notifications on a specific proposal
        ...
        <b-form-group
          ...
          label-for="checkbox-view-authored-requests-only"
        >
          <template slot="description">
        ...
        <b-form-group
          ...
          id="checkbox-group-staff-view"
          label-for="checkbox-staff-view"
        >
          <b-form-checkbox
    ...
    <b-col md="4">
      ...
      <p>
        ...
        <a
          :href="observationPortalApiUrl + '/api/'"
        >API</a>.
...
import { copyObject } from "~/assets/js/utils.js";
