      ...
      >
        ...
        >
          ...
          <ul class="list-unstyled">
            <li>
              <i
                class="fa fa-users fa-3x fa-pull-left"
                aria-hidden="true"
              />
            ...
            <li>
              <i
                class="fab fa-wpexplorer fa-3x fa-pull-left"
                aria-hidden="true"
              />
            ...
            <li>
              <i
                class="fa fa-cloud-download-alt fa-3x fa-pull-left"
                aria-hidden="true"
              />
          ...
          <router-link
            class="btn btn-lg btn-success col-md-5"
            :to="{name: 'register'}"
          >
            Register an Account
          </router-link>
          <router-link
            :to="{name: 'login'}"
            class="btn btn-lg btn-info float-right col-md-5 col-md-offset-2"
          >
            Login
          </router-link>
          <br>
      ...
      >
            ...
            <ul class="list-unstyled sidebar-nav">
              <li>
                <router-link :to="{name: 'create'}">
                  <i class="fab fa-wpexplorer fa-2x fa-fw" /> Submit Observation
                </router-link>
              </li>
              <li>
        ...
        <b-row>
          <div class="col-md-12">
            ...
            Check out the <router-link :to="{name: 'help'}">
              help page.
            </router-link>
          </div>
        </b-row>
        ...
        <p>
          This chart shows the percent of operational science time for each telescope over the last 4
          days. View the <a href="https://lco.global/observatory/status/">detailed operational status.</a>
        </p>
        ...
        <b-row v-if="userIsAuthenticated">
          <b-col>
            ...
            <div
              v-for="proposal in currentProposals"
              :key="proposal.id"
            >
              <p>
